...
@section('content')
    ...
    <div class="container content-tasknow">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form action = "{{route('tarefa.store')}}" method = "POST" class="">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="tipoTarefa" class="form-control">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="range" class="range-tasknow" min=0 max=1 id="privacidade">
